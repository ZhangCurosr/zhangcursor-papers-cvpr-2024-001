...
CVPR 2024（IEEE/CVF Conference on Computer Vision and Pattern Recognition）会议论文的解析归档。

<!-- 胶囊徽章带：论文数 / 最近更新 / 流水线 / License -->
![Papers](https://img.shields.io/badge/Papers-136-brightgreen?style=flat-square)
![Last commit](https://img.shields.io/github/last-commit/ZhangCurosr/zhangcursor-papers-cvpr-2024-001?style=flat-square)
...
- **内容**：CVPR 2024 会议论文（含主会 / 海报）。
- **来源**：https://openaccess.thecvf.com/CVPR2024
...
# 按标题搜索（示例）
git ls-remote https://github.com/ZhangCurosr/zhangcursor-papers-cvpr-2024-001.git
```
...
| 时间 (UTC) | 动作 |
|---|---|
| 每天 02:00 / 14:00 | 自动抓取新论文 → MinerU 解析 → 推送本仓库 |
...
- 仅收录 MinerU 服务可达的论文源（本库为 CVPR 2024）
